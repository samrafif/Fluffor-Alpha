...
def plot_classifier(net, X_data, Y_data, x_meshgrid, y_meshgrid, X_grid, export_path=None):
...
X1_test = np.random.multivariate_normal([0, 0], [[0.1, 0], [0, 0.1]], size=n_class_size) + X1_offset
